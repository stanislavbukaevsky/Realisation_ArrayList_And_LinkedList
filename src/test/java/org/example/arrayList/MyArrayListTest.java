...
/**
 * Класс с тестами для ArrayList
 */
public class MyArrayListTest {
    private final MyList<String> myList = new MyArrayList<>();
    ...
    public void addForIndexTest() {
        ...
        assertThrows(RuntimeException.class, () -> myList.add(TEST_CONSTANT_NEGATIVE_SCRIPT_INDEX, TEST_CONSTANT_NEGATIVE_SCRIPT_ELEMENT));
    }
    ...
    public void setElementForIndexTest() {
        ...
        assertThrows(NullPointerElementException.class, () -> myList.set(TEST_CONSTANT_THREE_INDEX, TEST_CONSTANT_NEGATIVE_SCRIPT_ELEMENT));
    }
